...
<html>
    <head>
        ...
        <title>Lecture Details - Teacher</title>   
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="/OAS/teacher/lectures">Lectures</a></li>
                                        ...
                                        <tbody id="present">
                                            <c:forEach var="student" items="${requestScope.present}">
                                                <tr id="${student.id}">
                                                    ...
                                                    <td><a href="/OAS/teacher/students/detailstudent?studentId=${student.id}">${student}</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
