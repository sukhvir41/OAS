...
<html>
    <head>
        ...
        <title>Admin Details - Admin</title>   
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4>Username : <c:out value="${requestScope.admin.user.username}"/></h4>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <dl>
                                                <dt>Email Address</dt>
                                                <dd><c:out value="${requestScope.admin.user.email}"/></dd>
                                                <dt>Admin Type</dt>
                                                <dd><c:out value="${requestScope.admin.type}"/></dd>
                                            </dl>
                                            <c:if test="${requestScope.admin.type=='Sub'}">
                                            ...
                                            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="form-horizontal mb-lg" action="/OAS/admin/admins/delete-admin-post" method="POST">
                                                            <div class="modal-body">

                                                                <input type="hidden" name="adminId" value='<c:out value="${requestScope.admin.user.id}"/>'>
