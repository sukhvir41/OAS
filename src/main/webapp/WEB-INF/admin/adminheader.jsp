...
<header id="header"
    data-plugin-options='{"stickyEnabled": true, "stickyEnableOnBoxed": true, "stickyEnableOnMobile": true, "stickyStartAt": 57, "stickySetTop": "-10px", "stickyChangeLogo": true}'>
                        ...
                        <div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1 collapse">
                            <nav>
                                <ul class="nav nav-pills" id="mainNav">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown-submenu">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="/OAS/admin/teachers/unaccounted">Unaccounted
                                                            Teachers</a></li>
                                                </ul>
                                            </li>
                                            <li class="dropdown-submenu">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="/OAS/admin/students/unaccounted">Unaccounted
                                                            Students</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    ...
                                    <li>
                                        <a href="/OAS/admin/network-settings">Network settings</a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            <div class="user-avatar">
                                                                <p><strong>${sessionScope.admin.user.username}</strong><span>Administrator
                                                                        ${sessionScope.admin.type}</span></p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
