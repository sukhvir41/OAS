                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-hover table-striped">
                                            ...
                                            <c:forEach var="department" items="${requestScope.departments}" varStatus="count">
                                                <tr>
                                                    <td>${count.index + 1}<a name="${department.id}"></a></td>
                                                    <td><a href="/OAS/admin/departments/department-details?departmentId=${department.id}">${department.name}</a></td>
