<%-- 
    Document   : editcourse
    Created on : Jan 11, 2017, 11:38:31 PM
    Author     : sukhvir
--%>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li><a href="/OAS/admin/courses">Course</a></li>
                                <li>Edit Course</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="/OAS/admin/courses/update-course" id='updateCourseForm' method="Post">
                                    <input type="hidden" name="courseId" value="${requestScope.course.id}">
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label>Course Name</label>
                                                <input class="form-control input-lg" type="text" name="courseName"
                                                    id="courseName" value="${requestScope.course.name}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
    ...
    <script src="/OAS/scripts/admin/edit-course.js"></script>
