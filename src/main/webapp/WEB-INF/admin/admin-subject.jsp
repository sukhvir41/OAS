    ...
    <div class="body">
        ...
        <div role="main" class="main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <form action="/OAS/admin/subjects/add-subject" method="post">
                            <h4>Add Subject</h4>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control input-lg" placeholder="subject name" type="text"
                                            name="subjectname" id="subjectname" required="true">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-8">
                                        ...
                                        <span class="checkbox">
                                            <label class="checkbox"><input type="checkbox" name="elective"
                                                    value="true">Elective</label>
                                        </span>
                                    </div>
                                </div>
                            </div>
