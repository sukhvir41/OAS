...
<head>
    ...
    <title>Subject Details - Admin</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <h2>Subject :
                                    <c:out value="${requestScope.subject.name}" />
                                </h2>
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4>Deatils</h4>
                                        <dl>
                                            <dt>Name</dt>
                                            <dd>${requestScope.subject.name}</dd>
                                            <dt>Elective</dt>
                                            <dd>${requestScope.subject.elective}</dd>
                                            <dt>
                                                Course
                                            </dt>
                                            <dd>
                                                <a
                                                    href="/OAS/admin/courses/course-details?courseId=${requestScope.course.id}">
                                                    ${requestScope.course.name}
                                                </a>
                                            </dd>
                                            <dt>Class Rooms</dt>
                                            <dd>
                                                <c:if test="${fn:length(requestScope.subjectClassrooms) eq 0}">
                                                    No classrooms linked to subject
                                                </c:if>

                                                <c:forEach var="classroom" items="${requestScope.subjectClassrooms}">
                                                    <a
                                                        href="/OAS/admin/classrooms/classroom-details?classroomId=${classroom.id}">${classroom.name}</a><br>
                                                </c:forEach>
                                            </dd>
                                        </dl>
                                        <a class="mb-xs mt-xs mr-xs btn btn-primary"
                                            href="/OAS/admin/subjects/edit-subject?subjectId=${requestScope.subject.id}">Edit</a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form-horizontal mb-lg"
                                                        action="/OAS/admin/subjects/deletesubject" method="post">
                                                        <div class="modal-body">

                                                            <input type="hidden" name="subjectId"
                                                                value="${requestScope.subject.id}">
                                                            <label>Deleting the subject directly will make the system
                                                                unpredictable and may cause some problems</label>
                                                            <label><b>Its is advised to delete the subjectss respective
                                                                    data first before deleting the subject</b></label>
                                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <form action="/OAS/admin/subjects/add-subject-to-classrooms" method="post">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-8">
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${fn:length(requestScope.classRooms) eq 0}">
                                                                <label>Can't add classrooms to the subject as there
                                                                    arn't any</label>
                                                            </c:when>
                                                            ...
                                                            <c:otherwise>
                                                                ...
                                                                <div id="class">
                                                                    <c:forEach var="classroom"
                                                                        items="${requestScope.classRooms}">
                                                                        <span class="checkbox"><label
                                                                                class="checkbox"><input type="checkbox"
                                                                                    name="classes"
                                                                                    value="${classroom.id}">${classroom.name}</label></span>
                                                                    </c:forEach>
                                                                </div>
                                                            </c:otherwise>
                                                        </c:choose>
                                            ...
                                            <div class="row">
                                                ...
                                                <c:if test="${fn:length(requestScope.classRooms) gt 0}">
