                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="/OAS/admin/set-network-settings" method="Post">
                                        ...
                                        <c:choose>
                                            <c:when test="${requestScope.handlerReady}">
                                                <div class="alert alert-success">
                                                    <strong>Message!</strong> The network is set with the follwing setting.
                                                </div>
                                            </c:when>
                                            <c:otherwise>
                                                <div class="alert alert-danger">
                                                    <strong>Warning!</strong> Please set the network settings
                                                </div>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>Available network interfacees on the machine</label>
                                        <ul class="list list-icons list-icons-sm">
                                            <c:forEach var="network" items="${requestScope.networkInfoList}">
                                                <li>
                                                    <i class="fa fa-caret-right"></i>
                                                    Network Name : <c:out value="${network.displayName}"/> <br/>
                                                    Ip Addresses : <c:out value="${network.ipAddresses}"/> <br/>
                                                    Mac Address : <c:out value="${network.macAddress}"/>
                                                </li>
                                            </c:forEach>
                                        </ul>
                                    </div>
