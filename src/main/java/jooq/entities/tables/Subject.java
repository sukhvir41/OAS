...
public class Subject extends TableImpl<SubjectRecord> {
    ...
    private static final long serialVersionUID = 1064722658;
     ...
     */
    public final TableField<SubjectRecord, Long> COURSE_FID = createField("course_fid", org.jooq.impl.SQLDataType.BIGINT, this, "");
    ...
    public List<ForeignKey<SubjectRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<SubjectRecord, ?>>asList(Keys.SUBJECT__SUBJECT_COURSE_FOREIGN_KEY);
    }

    public Course course() {
        return new Course(this, Keys.SUBJECT__SUBJECT_COURSE_FOREIGN_KEY);
    }
