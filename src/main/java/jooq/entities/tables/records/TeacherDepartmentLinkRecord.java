...
public class TeacherDepartmentLinkRecord extends UpdatableRecordImpl<TeacherDepartmentLinkRecord> implements Record2<Long, UUID> {

    private static final long serialVersionUID = -2056260762;
     ...
     */
    @Override
    public TeacherDepartmentLinkRecord value1(Long value) {
     ...
     */
    @Override
    public TeacherDepartmentLinkRecord value2(UUID value) {
        setTeacherFid(value);
        return this;
    }
     ...
     */
    @Override
    public TeacherDepartmentLinkRecord values(Long value1, UUID value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public TeacherDepartmentLinkRecord(Long departmentFid, UUID teacherFid) {
        super(TeacherDepartmentLink.TEACHER_DEPARTMENT_LINK);
