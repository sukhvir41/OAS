...
public class Lecture extends TableImpl<LectureRecord> {
    ...
    private static final long serialVersionUID = 2049962424;
    ...
    /**
     * The column <code>public.lecture.tcs_fid</code>.
     */
    public final TableField<LectureRecord, Long> TCS_FID = createField("tcs_fid", org.jooq.impl.SQLDataType.BIGINT, this, "");
    ...
    public List<ForeignKey<LectureRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<LectureRecord, ?>>asList(Keys.LECTURE__LECTURE_TCS_FOREIGN_KEY);
    }

    public Tcs tcs() {
        return new Tcs(this, Keys.LECTURE__LECTURE_TCS_FOREIGN_KEY);
    }
