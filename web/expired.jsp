<%-- 
    Document   : expired
    Created on : Dec 27, 2016, 2:34:39 AM
    Author     : sukhvir
    --%>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-md-12 center">
								<h1 class="mb-sm small">Expired</h1>
								<p class="lead">Oops! The link you are trying to access is expired.<br>Try to generate a new one or contact the adminstrative staff for any other problem</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
