...
<html>
    ...
    <body>
                            			...
                            			<div class="col-md-6">
                            				<div class="row">
                                            	<div class="form-group">
                                                	<div class="col-md-6">
                                                    	<h4>Start Date</h4>
                                                    	<input required="true" class="form-control" type="date" id="startdate" name="startdate">
                                                	</div>
                                            	</div>
                                        	</div>
                                        	<div class="row">
                                            	<div class="form-group">
                                                	<div class="col-md-6">
                                                    	<h4>End Date</h4>
                                                    	<input required="true" class="form-control" id="enddate" type="date" name="enddate">
                                                	</div>
                                            	</div>
                                        	</div>
                                        	<br>
        ...
        <script src="/OAS/scripts/adminlecture.js"></script>
