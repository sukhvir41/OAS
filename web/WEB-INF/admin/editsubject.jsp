...
<html>
    <head>
        ...
        <title>Edit Subeject - Admin</title>  
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="/OAS/admin/subjects">Subecjts</a></li>
                                        <li>Edit Subject</li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="/OAS/admin/subjects/updatesubject" method="Post">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    ...
                                                    <input class="form-control input-lg"  type="text" name="subjectname" id="subjectname" required="true" value="${requestScope.subject.name}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <c:choose>
                                                    <c:when test="${requestScope.subject.elective}">
                                                        <label>Elective</label>
                                                        <span class="checkbox"><label class="checkbox"><input type="checkbox" name="elective" value="true" checked="checked">elective</label></span>
                                                            </c:when>
                                                            <c:otherwise>
                                                        <label>Elective</label>
                                                        <span class="checkbox"><label class="checkbox"><input type="checkbox" name="elective" value="true">elective</label>
                                                        </span>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div id="class">
                                                    <c:forEach var="classroom" items="${requestScope.subject.classRooms}">
                                                        <span class="checkbox"><label class="checkbox"><input type="checkbox" name="classes" value="${classroom.id}" checked="checked">${classroom.name}</label></span>
                                                            </c:forEach>
                                                </div>
                                            </div>
                                        </div>
