                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="/OAS/admin/courses/updatecourse" method="Post">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    ...
                                                    <input class="form-control input-lg"  type="text" name="coursename" id="coursename" required="true" value="${requestScope.course.name}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
