...
<html>
    <head>
        ...
        <title>Edit Class Room - Admin</title>  
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="/OAS/admin/classrooms/updateclassroom" method="post">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control input-lg" placeholder="class room name" type="text" name="classroomname" id="classroomname" required="true" value="${requestScope.classroom.name}">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control input-lg" placeholder="A" type="text" name="division" id="division" required="true" value = "${requestScope.classroom.division}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control input-lg" placeholder="1" type="number" name="semister" id="semister" required="true" value="${requestScope.classroom.semister}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control input-lg" placeholder="1" type="number" name="minimumsubjects" id="minimumsubjects" required="true" value="${requestScope.classroom.minimumSubjects}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class= "row">
