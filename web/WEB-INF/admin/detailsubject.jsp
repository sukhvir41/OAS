                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2>Subject : <c:out value="${requestScope.subject.name}"/></h2>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4>Deatils</h4>
                                            <dl>
                                                ...
                                                <dt>Course</dt>
                                                <dd>${requestScope.subject.course.name}</dd>
                                                <dt>Class Rooms</dt>
                                                <dd>
                                                    <c:forEach var="classroom" items="${requestScope.subject.classRooms}">
                                                        ${classroom.name}<br>
                                                    </c:forEach>
                                                </dd>
                                            </dl>
                                            <a class="mb-xs mt-xs mr-xs btn btn-primary" href="/OAS/admin/subjects/editsubject?subjectId=${requestScope.subject.id}">Edit</a>
                                            ...
                                            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="form-horizontal mb-lg" action="/OAS/admin/subjects/deletesubject" method="post">
                                                            <div class="modal-body">

                                                                <input type="hidden" name="subjectId" value="${requestScope.subject.id}">
                                                                <label>Deleting the subject directly will make the system unpredictable and may cause some problems</label>
                                                                <label><b>Its is advised to delete the subjectss respective data first before deleting the subject</b></label>
                                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <form action="/OAS/admin/subjects/addsubjecttoclassrooms" method="post">
                                                <input type="hidden" name="subjectId" value="${requestScope.subject.id}">
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <div id="class">
                                                                <c:forEach var="classroom" items="${requestScope.classrooms}">
                                                                    <span class="checkbox"><label class="checkbox"><input type="checkbox" name="classes" value="${classroom.id}">${classroom.name}</label></span>
                                                                        </c:forEach>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach var="student" items="${requestScope.subject.students}">
                                                        <tr>
                                                            <td>${student.id}</td>
                                                            <td><a href="/OAS/admin/studets/detailstudent?studentId=${student.id}">${student}</a></td>
