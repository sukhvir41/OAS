                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="heading heading-primary heading-border heading-bottom-border">
                                    <h1 class="heading-primary">Memory Usage</h1>
                                </div>
                                <canvas id="memChart" class="col-md-12"></canvas>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="heading heading-primary heading-border heading-bottom-border">
                                    <h1 class="heading-primary">CPU Usage</h1>
                                </div>
                                <canvas id="cpuChart" class="col-md-12"></canvas>
                            </div>
