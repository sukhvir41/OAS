                                        ...
                                        <tbody>
                                            <c:forEach var="course" items="${requestScope.courses}">
                                                <tr>
                                                    ...
                                                    <td><a href="/OAS/hod/courses/detailcourse?courseId=${course.id}">${course.name}</a></td>
                                                    <td>${course.started}</td>
                                                    <td>${course.department.name}</td>
                                                    <td><a class="mb-xs mt-xs mr-xs btn btn-primary" href="/OAS/hod/courses/editcourse?courseId=${course.id}&from=courses">Edit</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
