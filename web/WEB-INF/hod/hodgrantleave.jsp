<%-- 
    Document   : hodgrantleave
    Created on : 24 Mar, 2017, 12:03:22 AM
    Author     : icr
--%>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="/OAS/hod/students">Students</a></li>
                                    <li>Grant Leave</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form action="/OAS/hod/students/grantleavepost" method="post">
                                    	<div class="row">
                                    		<div class="form-group">
                                    			<div class="col-md-4">
                                                    ...
                                                    <input type="text" name="studentId" id="studentId" value="${requestScope.student.id}" hidden="true">
