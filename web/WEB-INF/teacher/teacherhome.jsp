                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-control input-lg mb-md"  name="teachingId" id="teaching" required="true">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control input-lg mb-md"  name="NumberOfLectures" id="count" required="true">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <a class="mb-xs mt-xs mr-xs btn btn-primary">Test</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
