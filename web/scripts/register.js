...
$(document).ready(function(){
	...
	$("#password1").blur(function(){passwordCheck();});
	$("#password2").blur(function(){passwordCheck();});
	$("#firstname").blur(function(){firstNameCheck();});
	$("#lastname").blur(function(){lastNameCheck();});
	$("#email").blur(function(){emailTakenCheck();});
	$("#username").blur(function(){usernameTakenCheck();});
	$("#number").blur(function(){numberCheck();});
	$("#rollnumber").blur(function(){rollNumberCheck();});

	$("#course").change(function(){getClasses();});
	$("#class").change(function(){getSubjects()});
